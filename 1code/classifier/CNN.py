...
ytest_sum.to_csv('ytest_sum_CNN_Near_Miss_train_fusion.csv')

yscore_=yscore[np.array(range(1,row)),:]
yscore_sum = pd.DataFrame(data=yscore_)
yscore_sum.to_csv('yscore_sum_CNN_Near_Miss_train_fusion.csv')
...
data_csv.to_csv('CNN_Near_Miss_train_fusion.csv')
