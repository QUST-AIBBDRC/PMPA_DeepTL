...
data_=pd.read_csv(r'Near_Miss_train_fusion.csv')
data=np.array(data_)
data=data[:,1:]
[m1,n1]=np.shape(data)
...
def get_con_model():
    ...
    protein_input1 = Dense(256, activation='sigmoid', init='glorot_normal', name='High_dim_feature_1')(input_1)
    protein_input1=Dropout(0.5)(protein_input1)
    protein_input1 = Dense(128, activation='sigmoid', init='glorot_normal', name='High_dim_feature_2')(protein_input1)
    protein_input1=Dropout(0.5)(protein_input1)
    protein_input1 = Dense(64, activation='sigmoid', init='glorot_normal', name='High_dim_feature_3')(protein_input1)
    protein_input1=Dropout(0.5)(protein_input1)
    output = Dense(32, activation='sigmoid', init='glorot_normal', name='High_dim_feature')(protein_input1)
...
yscore_sum.to_csv('1yscore_sum_DNN_Near_Miss_train_fusion.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('1ytest_sum_DNN_Near_Miss_train_fusion.csv')
...
data_csv.to_csv('DNN_Near_Miss_train_fusion.csv')
